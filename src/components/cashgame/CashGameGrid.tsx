...
import { CashHandMatrix, HandAction, CashAction, getActionColor } from '@/types/cashGame.ts';
...
export function CashGameGrid({ hands, onChange, availableActions, isEditing = false }: CashGameGridProps) {
